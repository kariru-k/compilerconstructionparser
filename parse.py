...
class Parser:
    def __init__(self, lexer):
        ...
        self.symbols = set()  # Save variables declared.
        self.labelsDeclared = set()  # Save labels declared.
    ...
    # program ::= {statement}
    def program(self):
        print("[PROGRAM(" + self.curToken.text + ")]")
    ...
    # statement ::= {variable} {assignment} {print} {goto} {if} {while} {return}
    def statement(self):
        ...
        # "IF" comparison "THEN" {statement} "ENDIF"
            ...
            print("[STATEMENT-IF (" + self.curToken.text + ")]")
            self.nextToken()
            self.comparison()
        ...
        # "WHILE" comparison "REPEAT" {statement} "ENDWHILE"
            ...
            print("[STATEMENT-WHILE(" + self.peekToken.text + ")]")
            self.nextToken()
            self.comparison()
    ...
    def comparison(self):
        print("[COMPARISON(" + self.curToken.text + ")]")
